...
@interface HumDotaVideoCateOneView(){
...
@implementation HumDotaVideoCateOneView
...
-(HumDotaCateTowBaseView *)viewForCatOneIdx:(int)oneIdx TwoIdx:(int)twoIdx VCtl:(HumDotaBaseViewController *)vctl Frame:(CGRect)frm {
    ...
    HumDotaVideCateTwoView *video = [[[HumDotaVideCateTwoView alloc] initWithDotaCatFrameViewCtl:vctl Frame:frm CategoryId:subCat.catId] autorelease];
    return video;
