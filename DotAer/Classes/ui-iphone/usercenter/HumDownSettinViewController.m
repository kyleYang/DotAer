...
@interface HumDownSettinViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HumDownSettinViewController
...
//    "settin.video.play.qulity.setting" = "播放设置";
    ...
    self.navigationItem.title = NSLocalizedString(@"settin.video.down.qulity.setting", nil);
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    VideoScreen type =[HumDotaUserCenterOps intValueReadForKey:kScreenDownType];
...
- (void)norCellSelect{
    [HumDotaUserCenterOps intVaule:VideoScreenNormal saveForKey:kScreenDownType];
...
- (void)hdCellSelect{
    [HumDotaUserCenterOps intVaule:VideoScreenHD saveForKey:kScreenDownType];
    [HumDotaUIOps popUIViewControlInNavigationControl:self];
