...
@interface HumDotaPadImageCateOneView()
...
@implementation HumDotaPadImageCateOneView
...
-(HumDotaPadCateTowBaseView *)viewForCatOneIdx:(int)oneIdx TwoIdx:(int)twoIdx VCtl:(HumPadDotaBaseViewController *)vctl Frame:(CGRect)frm {
    ...
    HumDotaPadImageCateTwoView *image = [[[HumDotaPadImageCateTwoView alloc] initWithDotaCatFrameViewCtl:vctl Frame:frm CategoryId:subCat.catId] autorelease];
    return image;
