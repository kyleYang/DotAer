...
@interface HumVideoPadTableCell()
{
    UIButton *_cellSelct;
}
...
@implementation HumVideoPadTableCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.summary = [[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(self.videoCover.frame), CGRectGetMaxY(self.videoCover.frame)+kVSGap, CGRectGetWidth(self.frame)-2*kOrgX, 0)] autorelease];
        self.summary.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        self.summary.font = kSumaryFont;
        ...
        self.timeLeb.font = [UIFont systemFontOfSize:14.0f];
