...
@interface HumDotaPadCateTwoTableView()<UITableViewDelegate, UITableViewDataSource, EGORefreshTableHeaderDelegate,UISearchBarDelegate,pgFootViewDelegate>


@end


@implementation HumDotaPadCateTwoTableView
