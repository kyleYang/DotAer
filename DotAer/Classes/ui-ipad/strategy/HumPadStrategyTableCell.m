...
@implementation HumPadStrategyTableCell
@synthesize title;
@synthesize timeLeb;
@synthesize summary;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        CGRect frame = CGRectMake(kOrgX, kOrgY, CGRectGetWidth(self.bounds)-kOrgX, 0);
        ...
        self.summary = [[[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(self.title.frame), CGRectGetMaxY(self.title.frame)+kTSGap, CGRectGetWidth(self.title.frame) , 0)] autorelease];
        self.summary.font = kSummaryFont;
        self.summary.numberOfLines = 0;
        self.summary.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        ...
        line.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin|UIViewAutoresizingFlexibleTopMargin|UIViewAutoresizingFlexibleWidth;
