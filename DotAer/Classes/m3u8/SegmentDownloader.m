...
-(id)initWithUrl:(NSString *)url andFilePath:(NSString *)path andFileName:(NSString *)_fileName{
    ...
    if(self != nil)
    {
        ...
        NSString *downloadingFileName = [[[NSString alloc] initWithString:[self.fileDir stringByAppendingPathComponent:[fileName stringByAppendingString:kTextDownloadingFileSuffix]]] autorelease];
