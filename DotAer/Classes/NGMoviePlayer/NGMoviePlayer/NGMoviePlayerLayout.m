...
- (void)setMoviePlayer:(NGMoviePlayer *)moviePlayer {
    if (moviePlayer != _moviePlayer) {
        ...
        self.settingControlsView = moviePlayer.view.controlsView.settingControlsView;
        ...
        self.settingControl = moviePlayer.view.controlsView.settingControl;
        self.downloadControl = moviePlayer.view.controlsView.downloadControl;
        self.videoTitle = moviePlayer.view.controlsView.videoTitle;
