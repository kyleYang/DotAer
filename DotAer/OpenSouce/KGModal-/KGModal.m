...
@property (nonatomic, retain) KGModalGradientView *styleView;
@end

@interface KGModal()
@property (nonatomic, retain) UIWindow *window;
@property (nonatomic, retain) KGModalViewController *viewController;
@property (nonatomic, retain) KGModalContainerView *containerView;
@property (nonatomic, retain) KGModalCloseButton *closeButton;
