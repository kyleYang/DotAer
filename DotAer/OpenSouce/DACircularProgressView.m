...
- (void)dealloc{
    [_trackTintColor release]; _trackTintColor = nil;
    [_progressTintColor release]; _progressTintColor = nil;
    [super dealloc];
}
...
- (UIColor *)trackTintColor
{
    if (!_trackTintColor)
    {
        _trackTintColor = [[UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:0.3f] retain];
    }
