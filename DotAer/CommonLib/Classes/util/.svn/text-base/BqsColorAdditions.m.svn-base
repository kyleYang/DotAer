...
///////////////////////////////////////////////////////////////////////////////////////////////////
void BqsRGBtoHSV(float r, float g, float b, float* h, float* s, float* v) {
  float min, max, delta;
  min = MIN3(r, g, b);
  max = MAX3(r, g, b);
  *v = max;        // v
...
///////////////////////////////////////////////////////////////////////////////////////////////////
void BqsHSVtoRGB( float *r, float *g, float *b, float h, float s, float v ) {
  int i;
  float f, p, q, t;
  if ( s == 0 ) {
    // achromatic (grey)
...
- (CGFloat)hue {
  const CGFloat* rgba = CGColorGetComponents(self.CGColor);
  CGFloat h, s, v;
  BqsRGBtoHSV(rgba[0], rgba[1], rgba[2], &h, &s, &v);
  return h;
}
