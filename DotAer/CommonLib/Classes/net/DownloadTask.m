...
-(id)initWithUrl:(NSString*)sUrl Callback: (id<DownloadTaskCallback>)cb Attached:(id)iAttached {
    return [self initWithUrl:sUrl Callback:cb Attached:iAttached AppendPassport:YES];
}
-(id)initWithUrl:(NSString*)sUrl Callback: (id<DownloadTaskCallback>)cb Attached:(id)iAttached AppendPassport:(BOOL)bAppendPassport {
