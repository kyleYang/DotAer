...
@interface DownloadTask : NSObject
{
	...
	id<DownloadTaskCallback> _cbCallback;
...
@property (assign, readwrite) id<DownloadTaskCallback> callback;
...
-(id)initWithUrl:(NSString*)sUrl Path:(NSString*)sPath Callback: (id<DownloadTaskCallback>)cb ProgressCallback: (id<DownloadProgressCallback>)pcb Resume: (BOOL)bResume Attached:(id)iAttached;
-(id)initWithUrl:(NSString*)sUrl Path:(NSString*)sPath Callback: (id<DownloadTaskCallback>)cb ProgressCallback: (id<DownloadProgressCallback>)pcb Resume: (BOOL)bResume Attached:(id)iAttached AppendPassport:(BOOL)bAppendPassport;
-(id)initWithUrl:(NSString*)sUrl Path:(NSString*)sPath Callback: (id<DownloadTaskCallback>)cb ProgressCallback: (id<DownloadProgressCallback>)pcb Resume: (BOOL)bResume Attached:(id)iAttached AppendPassport:(BOOL)bAppendPassport UserName:(NSString*)userName Password:(NSString*)password AddtionalHeaders:(NSDictionary*)reqHeader;

-(id)initWithUrl:(NSString*)sUrl Callback: (id<DownloadTaskCallback>)cb Attached:(id)attached;
-(id)initWithUrl:(NSString*)sUrl Callback: (id<DownloadTaskCallback>)cb Attached:(id)attached AppendPassport:(BOOL)bAppendPassport;

-(id)initPostWithUrl:(NSString*)sUrl Data:(NSData*)data ContentType:(NSString*)sContentType Path:(NSString*)sPath Callback: (id<DownloadTaskCallback>)cb ProgressCallback: (id<DownloadProgressCallback>)pcb Attached:(id)iAttached AppendPassport:(BOOL)bAppendPassport UserName:(NSString*)userName Password:(NSString*)password AddtionalHeaders:(NSDictionary*)aReqHeader;
...
@protocol DownloadTaskCallback <NSObject>
